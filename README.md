...
int main() {
    ...
    do {
        ...
        cout << "3. Ver cola de procesos" << endl;
        cout << "4. Ejecutar proceso (desencolar)" << endl;
        cout << "5. Asignar memoria" << endl;
        cout << "6. Liberar memoria" << endl;
        cout << "7. Modificar prioridad de un proceso" << endl;
        cout << "8. Ver lista de procesos" << endl;
        cout << "9. Salir" << endl;
        ...
        case 1: {
            ...
            // Validar prioridad
            while (true) {
                cout << "Ingrese prioridad del proceso (entero positivo): ";
                cin >> entrada;
                ...
                if (esEntero && !entrada.empty()) {
                    prioridad = stoi(entrada);
                    break;
                } else {
                    cout << "Prioridad no válida. Debe ser un número entero mayor o igual a 0." << endl;
                    cin.clear();
                    cin.ignore(1000, '\n');
                }
            }

            Proceso* p = new Proceso(id, nombre, prioridad);
            gestorProcesos.insertar(p);
            planificadorCPU.encolar(*p);
            gestorMemoria.push(*p);
            // Commit: Junior - Implementación de la interacción con el usuario para agregar procesos
            break;
        }
        case 2: {
            int id;
            ...
            // Commit: Junior - Implementación de la eliminación de procesos por ID
            break;
        }
        case 3:
            planificadorCPU.mostrar_cola();
            break;
        case 4:
        ...
        case 5: {
            int id;
            cout << "Ingrese ID del proceso para asignar memoria: ";
            cin >> id;
            Proceso* p = gestorProcesos.buscar(id);
            if (p != NULL)
                gestorMemoria.push(*p);
            else
        ...
        case 7: {
            ...
            while (true) {
                cout << "Ingrese nueva prioridad (entero positivo): ";
                cin >> entrada;
            ...
            gestorProcesos.modificar_prioridad(id, nueva);
            break;
        }
        case 8:
            gestorProcesos.mostrar();
            break;
        case 9:
